              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="<?php echo base_url(); ?>assets/AdminLTE/#revenue-chart" data-toggle="tab">Area</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="<?php echo base_url(); ?>assets/AdminLTE/#sales-chart" data-toggle="tab">Donut</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="<?php echo base_url(); ?>assets/AdminLTE/#">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="pagination pagination-sm">
                    <li class="page-item"><a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="page-link">&laquo;</a></li>
                    <li class="page-item"><a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="page-link">1</a></li>
                    <li class="page-item"><a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="page-link">2</a></li>
                    <li class="page-item"><a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="page-link">3</a></li>
                    <li class="page-item"><a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="page-link">&raquo;</a></li>
                  </ul>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu float-right" role="menu">
                      <a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="dropdown-item">Add new event</a>
                      <a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="dropdown-item">Clear events</a>
                      <div class="dropdown-divider"></div>
                      <a href="<?php echo base_url(); ?>assets/AdminLTE/#" class="dropdown-item">View calendar</a>
                    </div>
                  </div>
